        ...
        {step === 'FIRST_TIME_OTP' && (
          <div>
            ...
            <Form form={formOtp} layout="vertical" onFinish={handleVerifyFirstTimeOtp} size="large">
              <Form.Item
                name="otp"
                label={<span className="text-xs font-semibold text-slate-700">Enter OTP</span>}
                rules={[
                  { required: true, message: 'Please enter the OTP' },
                  { min: 4, max: 6, message: 'OTP must be 4 to 6 digits' },
                ]}
              >
                <Input
          ...
          <div>
            ...
            <Form layout="vertical" onFinish={handleVerifyForgotOtp} size="large">
              <Form.Item
                name="otp"
                label={<span className="text-xs font-semibold text-slate-700">Enter OTP</span>}
                rules={[{ required: true, min: 4, max: 6, message: 'Enter valid OTP' }]}
              >
                <Input
                  prefix={<KeyOutlined className="text-emerald-600" />}
                  placeholder="• • • •"

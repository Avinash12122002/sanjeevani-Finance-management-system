            ...
            label: (
              <div className="flex items-center justify-between w-full pr-1">
                ...
                {typeof item.badge === 'number' && item.badge > 0 ? (
                  <span
                    className={`ml-2 rounded-full bg-slate-800 text-emerald-400 border border-emerald-500/30 inline-flex items-center justify-center font-bold leading-none shrink-0 shadow-sm ${item.badge < 10
      ...
      <div className="lg:ml-[260px] min-h-screen flex flex-col transition-all">
        ...
        <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200 px-4 sm:px-6 py-3 shadow-sm flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div
              className={`px-3 py-1.5 rounded-xl border text-xs font-semibold flex items-center gap-1.5 transition-all shadow-sm ${sessionTime < 60
                  ...
                  <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-3">
                    ...
                    <Descriptions bordered column={1} size="small" className="bg-slate-50/50 rounded-xl overflow-hidden">
                      ...
                      <Descriptions.Item label="City & State">
                        <span className="font-semibold text-slate-800">{customer.city || 'Delhi'}, {customer.state || 'Delhi'}</span>
                      </Descriptions.Item>
                      <Descriptions.Item label="Postal PIN Code">
                        <span className="font-mono font-bold text-slate-800">{customer.postalCode || '110086'}</span>
                      </Descriptions.Item>
                    </Descriptions>
                  </div>
